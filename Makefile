...
wrebuild:
	$(MAKE) CMAKE_GENERATOR=$(WINDOWS_GENERATOR) PACKAGE_COMMAND=$(WINDOWS_PACKAGE_COMMAND) SYSTEM_PACKAGES=OFF ADDITIONAL_OPTIONS="-DSDL_PRESEED=OFF" configure build install package
erebuild:
