...
void BattleWidget::ShowBattleWidget() {
	...
	// 	auto anim = sgGameObjectGetComponent(go, AnimationComponent);
	// 	auto player = sgGameObjectGetComponent(go, PlayerComponent);
	// 	auto loc = sgGameObjectGetComponent(go, LocationComponent);
