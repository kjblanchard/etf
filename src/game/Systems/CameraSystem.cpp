...
void InitializeCamera() {
	...
	// tweener->UpdateFunc = []() {
	// 	auto c = sgGameObjectGetGameObjectWithComponents(CameraComponent);
	// 	auto g = sgGameObjectGetGameObjectWithComponents(GameState);
	// 	auto cc = sgGameObjectGetComponent(c, CameraComponent);
	// 	auto gc = sgGameObjectGetComponent(g, GameState);
