...
static void loadPlayer(GameObject, PlayerSpawnComponent& playerSpawn, GameState& gameState) {
	...
	sgGameObjectAddComponent(go, AnimationComponent, &playerAnimation);
	sgGameObjectAddComponent(go, LocationComponent, &playerLocation);
	sgGameObjectAddComponent(go, PlayerComponent, &playerComponent);
	sgGameObjectAddComponent(go, PlayerInteractionComponent, &playerInteraction);
