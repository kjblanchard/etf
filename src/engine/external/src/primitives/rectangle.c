...
#include <SupergoonEngine/prim/rectangle.h>
...
int geRectangleIsOverlap(geRectangle* lhs, geRectangle* rhs) {
	return SDL_HasRectIntersection((SDL_Rect*)lhs, (SDL_Rect*)rhs);
}

int geRectangleFIsOverlap(geRectangleF* lhs, geRectangleF* rhs) {
	return SDL_HasRectIntersectionFloat((SDL_FRect*)lhs, (SDL_FRect*)rhs);
}
geRectangleF geRectangleFGetOverlapRect(geRectangleF* lhs, geRectangleF* rhs) {
	...
	SDL_GetRectIntersectionFloat((SDL_FRect*)lhs, (SDL_FRect*)rhs, (SDL_FRect*)&r);
	return r;
}
...
geRectangle geRectangleGetOverlapRect(geRectangle* lhs, geRectangle* rhs) {
	...
	SDL_GetRectIntersection((SDL_Rect*)lhs, (SDL_Rect*)rhs, (SDL_Rect*)&r);
	return r;
}
